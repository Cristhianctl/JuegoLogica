...
public class DefoN2P3 extends javax.swing.JDialog {

    /**
     * Creates new form DefoN2P3
     */
    public DefoN2P3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("3. En la selva Central ¿Cuál es la principal fuente de deforestación?");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/defor6.jpg"))); // NOI18N

        btnDr1.setFont(new java.awt.Font("Fugaz One", 1, 14)); // NOI18N
        btnDr1.setForeground(new java.awt.Color(51, 51, 51));
        btnDr1.setText("Carpintería o Cajonería");
    ...
    private void btnDr1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDr1ActionPerformed
        this.hide();
        JOptionPane.showMessageDialog(null, "Muy Bien... vamos por el siguiente NIVEL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DefoN2P3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
