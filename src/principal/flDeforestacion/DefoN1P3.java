...
public class DefoN1P3 extends javax.swing.JDialog {

    
    public DefoN1P3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("3. ¿Cuáles son las principales causas de la deforestación? ");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/defor4.jpg"))); // NOI18N

        btnDr1.setFont(new java.awt.Font("Fugaz One", 1, 14)); // NOI18N
        btnDr1.setForeground(new java.awt.Color(51, 51, 51));
        btnDr1.setText("fenómenos naturales. ");
        ...
        btnDr2.setText("Es la explotación maderera");
        ...
        btnDr3.setText("empresas no mineras");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DefoN1P3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
