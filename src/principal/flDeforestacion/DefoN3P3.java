...
public class DefoN3P3 extends javax.swing.JDialog {

    /**
     * Creates new form DefoN3P3
     */
    public DefoN3P3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("3. En el Perú. ¿Cuáles son las zonas mas afectadas por la deforestación? ");

        btnDr1.setFont(new java.awt.Font("Fugaz One", 1, 14)); // NOI18N
        btnDr1.setForeground(new java.awt.Color(51, 51, 51));
        btnDr1.setText("Loreto");
        ...
        btnDr2.setText("Ucayali y Pasco. ");
        ...
        btnDr3.setText("San Martin y Amazonas. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DefoN3P3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
