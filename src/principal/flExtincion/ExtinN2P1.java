...
public class ExtinN2P1 extends javax.swing.JDialog {

    /**
     * Creates new form ExtinN2P1
     */
    public ExtinN2P1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("1. ¿Cuál es la causa más común de la extinción de especies?");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/extin4.png"))); // NOI18N

        btnEr1.setFont(new java.awt.Font("Fugaz One", 1, 14)); // NOI18N
        btnEr1.setForeground(new java.awt.Color(51, 51, 51));
        btnEr1.setText("Destrucción de su habitad");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExtinN2P1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
