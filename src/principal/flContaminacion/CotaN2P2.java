...
public class CotaN2P2 extends javax.swing.JDialog {

    
    public CotaN2P2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("2. ¿Cuál de las siguientes instituciones cree usted, que es la");

        btnCr1.setFont(new java.awt.Font("Fugaz One", 1, 14)); // NOI18N
        btnCr1.setForeground(new java.awt.Color(51, 51, 51));
        btnCr1.setText("El Municipio ");
        ...
        btnCr3.setText("El Min. del M Ambiente  ");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/contap5.png"))); // NOI18N
        ...
        jLabel4.setText("responsable de elaborar las ordenanzas ambientales? ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CotaN2P2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
